...
import type { HitRunStackParamList, RootStackParamList } from '../../../navigation/types';
...
type Props = NativeStackScreenProps<HitRunStackParamList, 'GenerateReport'>;
...
export default function GenerateReport({ navigation }: Props) {
  ...
  const handleGeneratePDF = async () => {
    ...
    try {
      ...
      // share sheet dismissed or error — silent fail
    } finally {
      ...
      >
        ...
        <View style={styles.pdfSection}>
          ...
          <Text style={styles.pdfText}>
            A full insurance-ready PDF with all your photos, witness info, location,
        ...
        <View style={styles.infoBox}>
          <Text style={styles.infoText}>
            Your documentation is saved securely on this device. View it anytime in
            Incident History.
          </Text>
        </View>
      </ScrollView>
