...
type Props = NativeStackScreenProps<CrashStackParamList, 'Notes'>;
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        <View style={styles.content}>
          <Text style={styles.heading}>Describe what happened</Text>
          <Text style={styles.subheading}>
            Write as much detail as you can while it's fresh.
          </Text>
