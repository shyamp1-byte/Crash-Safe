...
type Props = NativeStackScreenProps<VandalismStackParamList, 'LocationCapture'>;
...
export default function LocationCapture({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <StepHeader title="Incident Location" step={2} total={8} onBack={() => navigation.goBack()} />
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        <Text style={styles.heading}>Where did the vandalism occur?</Text>
