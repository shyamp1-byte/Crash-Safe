...
import type { WeatherStackParamList, RootStackParamList } from '../../../navigation/types';
...
type Props = NativeStackScreenProps<WeatherStackParamList, 'GenerateReport'>;
...
export default function GenerateReport({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <StepHeader title="Incident Report" step={7} total={7} onBack={() => navigation.goBack()} />
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.pdfSection}>
          ...
          <Text style={styles.pdfText}>
            A full insurance-ready PDF with all your photos, location, and notes —
