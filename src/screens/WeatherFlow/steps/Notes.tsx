...
type Props = NativeStackScreenProps<WeatherStackParamList, 'Notes'>;

const PROMPTS = [
  'What type of weather caused the damage?',
  'Approximate time the damage occurred or was discovered?',
  'Were any other vehicles or property affected?',
  'Did you speak to any other witnesses or neighbors?',
...
export default function Notes({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <StepHeader title="Notes" step={6} total={7} onBack={() => navigation.goBack()} />
